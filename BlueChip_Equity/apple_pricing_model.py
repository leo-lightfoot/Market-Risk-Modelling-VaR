...
file_path = os.path.join(project_root, "Raw_Data", "combined_data_aapl.csv")
...
factor_columns = ["S&P 500 Index", "VIX Index", "USD Index", "Treasury Rate Proxy", 
                 "XLK Sector Index", "AAPL P/E Ratio"]
...
log_returns["S&P*XLK"] = log_returns["S&P 500 Index"] * log_returns["XLK Sector Index"]
...
log_returns["P/E*XLK"] = log_returns["AAPL P/E Ratio"] * log_returns["XLK Sector Index"]
log_returns["P/E*S&P"] = log_returns["AAPL P/E Ratio"] * log_returns["S&P 500 Index"]
log_returns["P/E*VIX"] = log_returns["AAPL P/E Ratio"] * log_returns["VIX Index"]
# Use raw dividend yield for interactions
log_returns["DIV*S&P"] = log_returns["DIVIDEND_YIELD"] * log_returns["S&P 500 Index"]
log_returns["DIV*XLK"] = log_returns["DIVIDEND_YIELD"] * log_returns["XLK Sector Index"]
...
plt.title(f"AAPL NAV Prediction | Log Returns + Interactions (RidgeCV) (R² = {r2_value:.4f})", fontsize=12)
...
# Save the plot
plot_path = os.path.join(current_dir, "nav_comparison_apple.png")
